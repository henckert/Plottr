...
describe('pitches integration', () => {
    ...
    test('GET /api/pitches/:id returns single pitch', async () => {
        ...
        // fetch single pitch
        const res = await (0, supertest_1.default)(app).get(`/api/pitches/${pitchId}`).expect(200);
        expect(res.body).toHaveProperty('data');
    ...
    test('GET /api/pitches/:id returns 404 for non-existent pitch', async () => {
        ...
        const res = await (0, supertest_1.default)(app).get('/api/pitches/99999').expect(404);
