...
const clerkBackend = __importStar(require("@clerk/backend"));
describe('Auth Middleware - Clerk JWT Validation', () => {
    ...
    describe('authMiddleware', () => {
        ...
        it('should return 401 when Authorization header has invalid format', async () => {
            ...
            if (mockNext.mock.calls[0]?.[0] instanceof errors_1.AppError) {
        ...
        it('should validate valid Bearer token with Clerk', async () => {
            ...
            clerkBackend.verifyToken.mockResolvedValue({
                sub: 'user_123456',
            ...
            if (clerkBackend.verifyToken.mock.calls.length > 0) {
        ...
        it('should return error for invalid token signature', async () => {
            ...
            clerkBackend.verifyToken.mockRejectedValue(new Error('Invalid token signature'));
            await (0, auth_1.authMiddleware)(mockReq, mockRes, mockNext);
    ...
    describe('requireAuth middleware', () => {
        it('should call next() when user is authenticated', () => {
            ...
            (0, auth_1.requireAuth)(mockReq, mockRes, mockNext);
